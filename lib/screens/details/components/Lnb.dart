...
class LNb extends StatefulWidget {
  @override
  _LnbState createState() => _LnbState();
}

class _LnbState extends State<LNb> {
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    ...
                    _products = [...products];
                    products.clear();
                    products = getProductCategory(KAllLnbR1);
  ...
  List<Product> getProductCategory(String KAllLnbR1) {
    List<Product> products = [];
    for (var product in _products) {
      if (product.color == KAllLnbR1 ) {
        products.add(product);
      }
    }
    return products;
